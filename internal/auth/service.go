...
const (
	...
	RoleRegionalCoordinator Role = "regional_coordinator"
	RoleCommunityProvider   Role = "community_provider"
	RoleLabCoordinator      Role = "lab_coordinator"
)
...
func New(ttl time.Duration, now func() time.Time, repositories ...Repository) *Service {
	...
	service := &Service{
		users: map[string]User{
			"national_admin":       {ID: "u-national-admin", Username: "national_admin", PasswordHash: hashPassword("national-admin-demo"), Role: RoleNationalAdmin},
			"regional_coordinator": {ID: "u-regional-coordinator", Username: "regional_coordinator", PasswordHash: hashPassword("regional-coordinator-demo"), Role: RoleRegionalCoordinator},
			"community_provider":   {ID: "u-community-provider", Username: "community_provider", PasswordHash: hashPassword("community-provider-demo"), Role: RoleCommunityProvider},
			"lab_coordinator":      {ID: "u-lab-coordinator", Username: "lab_coordinator", PasswordHash: hashPassword("lab-coordinator-demo"), Role: RoleLabCoordinator},
		},
